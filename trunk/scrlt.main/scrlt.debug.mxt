...
#P hidden newex 802 706 95 9109513 sel setdisplaywindow;
#P hidden message 785 730 62 9109513 settitle mixer;
#P hidden newex 785 753 92 9109513 js scrlt.util.settitle.js;
#P hidden newex 640 700 40 9109513 change;
#P hidden message 692 734 14 9109513 1;
#P hidden newex 692 709 28 9109513 sel 1;
#P hidden newex 692 684 34 9109513 active;
#P hidden message 730 709 14 9109513 0;
#P hidden newex 730 684 50 9109513 closebang;
#N comlet 0: closing 1: opening;
#P hidden outlet 692 759 15 0;
#N comlet dummy;
#P hidden inlet 654 651 15 0;
...
#P bpatcher 16 717 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.aux.1.mute;
#P bpatcher 16 733 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.aux.1.lvl;
#P bpatcher 16 749 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.aux.1.mon;
#P bpatcher 16 765 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.aux.1.aux.0;
#P bpatcher 16 653 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.aux.0.mute;
#P bpatcher 16 669 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.aux.0.lvl;
#P bpatcher 16 685 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.aux.0.mon;
#P bpatcher 16 701 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.aux.0.aux.1;
#P bpatcher 16 557 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.3.mute;
#P bpatcher 16 573 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.3.lvl;
#P bpatcher 16 589 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.3.mon;
#P bpatcher 16 605 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.3.aux.prefade;
#P bpatcher 16 621 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.3.aux.0;
#P bpatcher 16 637 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.3.aux.1;
#P bpatcher 16 461 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.2.mute;
#P bpatcher 16 477 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.2.lvl;
#P bpatcher 16 493 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.2.mon;
#P bpatcher 16 509 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.2.aux.prefade;
#P bpatcher 16 525 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.2.aux.0;
#P bpatcher 16 541 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.2.aux.1;
#P bpatcher 16 365 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.1.mute;
#P bpatcher 16 381 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.1.lvl;
#P bpatcher 16 397 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.1.mon;
#P bpatcher 16 413 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.1.aux.prefade;
#P bpatcher 16 429 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.1.aux.0;
#P bpatcher 16 445 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.1.aux.1;
#P bpatcher 16 269 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.0.mute;
#P bpatcher 16 285 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.0.lvl;
#P bpatcher 16 301 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.0.mon;
#P bpatcher 16 317 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.0.aux.prefade;
#P bpatcher 16 333 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.0.aux.0;
#P bpatcher 16 349 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.chan.0.aux.1;
#P bpatcher 16 253 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.master.mute;
#P bpatcher 16 237 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.master.lvl;
#P bpatcher 16 221 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.master.mon;
#P bpatcher 16 205 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.io.mon;
#P bpatcher 16 189 284 17 0 0 scrlt.debug.item.mxt 5 scrlt.mixer.io.main;
...
#P hidden connect 177 0 181 0;
#P hidden connect 180 0 181 0;
#P hidden connect 178 0 179 0;
#P hidden connect 179 0 180 0;
#P hidden connect 181 0 175 0;
#P hidden connect 176 0 177 0;
#P hidden connect 184 0 183 0;
#P hidden connect 183 0 182 0;
#P hidden connect 174 0 184 0;
#P pop;

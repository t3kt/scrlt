...
#P hidden newex 189 420 50 9109513 scrlt.trans;
#P objectname scrlt.trans;
#P hidden newex 146 421 41 9109513 pcontrol;
...
#P objectname rack;
#N vpatcher 330 459 1263 851;
#P window setfont "Sans Serif" 9.;
#P window linecount 1;
#P hidden newex 741 81 77 9109513 r scrlt.wind.trans;
#P hidden message 742 129 30 9109513 close;
#P hidden message 773 129 28 9109513 open;
#P hidden newex 742 104 72 9109513 sel 0 1;
#N comlet trans open;
#P outlet 773 151 15 0;
#N comlet trans close;
#P outlet 742 151 15 0;
#P hidden newex 735 206 79 9109513 s scrlt.wind.trans;
#N comlet wind.trans;
#P inlet 735 186 15 0;
#P inlet 436 31 15 0;
...
#P connect 56 0 54 0;
#P pop;
#P hidden newobj 270 344 47 9109513 p;
...
#P hidden newex 272 197 79 9109513 s scrlt.wind.trans;
#P hidden newex 384 197 90 9109513 rset scrlt.wind.trans;
#P hidden newex 265 147 140 9109513 s scrlt.wind.midi.bcr.vfunc.rack;
#P hidden newex 413 147 151 9109513 rset scrlt.wind.midi.bcr.vfunc.rack;
#P hidden newex 436 58 33 9109513 sel 32;
#P hidden newex 392 58 40 9109513 key;
#P hidden newex 272 173 109 9109513 s scrlt.wind.midi.mapper;
#P hidden newex 384 173 120 9109513 rset scrlt.wind.midi.mapper;
#P hidden newex 273 234 83 9109513 s scrlt.wind.debug;
#P hidden newex 365 234 94 9109513 rset scrlt.wind.debug;
#P hidden newex 265 124 91 9109513 s scrlt.wind.midi.bcr;
#P hidden newex 358 124 102 9109513 rset scrlt.wind.midi.bcr;
#P hidden newex 327 101 76 9109513 s scrlt.wind.rack;
#P hidden newex 409 101 87 9109513 rset scrlt.wind.rack;
#P hidden newex 257 80 81 9109513 s scrlt.wind.mixer;
#P hidden newex 339 80 92 9109513 rset scrlt.wind.mixer;
#P hidden newex 261 58 40 9109513 sel 1 0;
#P hidden message 334 58 26 9109513 stop;
#P hidden newex 362 58 28 9109513 dac~;
#P hidden message 304 58 27 9109513 start;
...
#P hidden connect 22 14 58 0;
#P hidden connect 22 13 58 0;

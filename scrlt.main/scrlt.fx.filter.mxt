max v2;
#N vpatcher 121 147 1191 884;
#P window setfont "Sans Serif" 9.;
#P window linecount 1;
#P hidden newex 477 165 72 9109513 scrlt.util.bcrfwd;
#P hidden newex 645 212 72 9109513 scrlt.util.bcrfwd;
#P hidden newex 705 286 72 9109513 scrlt.util.bcrfwd;
#P hidden newex 781 379 72 9109513 scrlt.util.bcrfwd;
#P hidden newex 695 164 72 9109513 scrlt.util.bcrfwd;
#P hidden newex 700 97 66 9109513 route $1.par.2;
#P hidden newex 700 74 69 9109513 r scrlt.bcr.map;
#P hidden newex 568 313 66 9109513 route $1.par.1;
#P hidden newex 568 290 69 9109513 r scrlt.bcr.map;
#P hidden newex 568 244 66 9109513 route $1.par.0;
#P hidden newex 568 221 69 9109513 r scrlt.bcr.map;
#P hidden newex 568 175 73 9109513 route $1.drywet;
#P hidden newex 568 152 69 9109513 r scrlt.bcr.map;
#P hidden newex 568 106 76 9109513 route $1.bypass;
#P hidden newex 568 83 69 9109513 r scrlt.bcr.map;
#P user ubutton 121 12 169 118 0 2;
#P noclick;
...
#P comment 88 65 33 9109513 2: gain;
...
#P hidden newex 245 328 51 9109513 pattr par.2;
#X prestore 1 0 36;
#P objectname par.2;
#P hidden newex 245 302 48 9109513 r $1.par.2;
#P hidden newex 95 328 51 9109513 pattr par.0;
#X prestore 1 0 65;
#P objectname par.0;
#P hidden newex 95 302 48 9109513 r $1.par.0;
#P hidden newex 245 226 48 9109513 r $1.par.1;
...
#P hidden newex 245 250 51 9109513 pattr par.1;
#X prestore 1 0 4;
#P objectname par.1;
#P comment 51 65 32 9109513 1: res;
...
#X logmarkers;
#X nfilters 1;
#X setfilter 0 2 0 0 0 742.677124 1. 0.73622 0. 22050. 0.0001 16. 0.5 25.;
#X done;
#P noclick;
...
#P noclick;
#P comment 51 25 35 9109513 0: freq;
#P hidden newex 501 344 39 9109513 *~ 0.1;
#P window setfont "Arial Black" 12.;
#P comment 5 3 135 10551308 fx.filter;
#P background;
...
#P hidden connect 26 0 68 0;
#P hidden connect 8 0 3 0;
#P hidden connect 55 0 68 1;
#P hidden connect 54 0 55 0;
#P hidden connect 56 0 57 0;
#P hidden connect 58 0 59 0;
#P hidden connect 60 0 61 0;
#P hidden connect 28 0 67 0;
#P hidden connect 33 0 64 0;
#P hidden connect 62 0 63 0;
#P hidden connect 31 0 66 0;
#P hidden connect 57 0 67 1;
#P hidden connect 63 0 64 1;
#P hidden connect 59 0 66 1;
#P hidden connect 24 0 65 0;
#P hidden connect 61 0 65 1;
#P pop;
